...
<body>
	...
	<div class="section">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<h1 class="text-center">UC003 - Mostrar Mototaxistas acima da
						média</h1>
	...
	<div id="margem-pequena">
		...
		<form
			action="<%=request.getContextPath()%>/cliente/MototaxistaServlet"
			method="post">
			...
			<div id="actions" class="row">
				<div class="col-md-12">
					<button type="submit" class="btn btn-success btn-xs" style="margin-botton: 30px;">Pesquisar</button>
					<button type="reset" class="btn btn-warning btn-xs" style="margin-botton: 30px;">Limpar</button>
				</div>
			</div>
		</form>
	</div>
