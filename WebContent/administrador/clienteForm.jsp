	...
	<div id="main" class="container-fluid">
		...
		<div class="section">
			<div class="container">
				...
				<form method="post"
					action="<%=request.getContextPath()%>/cliente/ClienteCRUD"
					name="formEmpr">
					...
					<div class="row">
						<div class="form group col-md-6">
							...
							<input type="text" name="cpf" value="${cliente.cpf}" class="form-control" id="cpf" placeholder="Digite o CPF"  class="required cpf"/>
							 <span>Campo obrigatório, informe um CPF válido</span>
						</div>
					</div>
